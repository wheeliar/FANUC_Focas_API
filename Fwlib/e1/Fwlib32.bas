...
#If F22_TYPEB Then
Public Const MAX_AXIS = 96
Public Const MAX_SPINDLE = 24
#ElseIf F22_TYPEA Then
Public Const MAX_AXIS = 72
Public Const MAX_SPINDLE = 14
#ElseIf F22_TYPE5 Then
...
Public Const MAX_SPINDLE = 4
#ElseIf PMD Then
Public Const MAX_AXIS = 6
Public Const MAX_SPINDLE = 1
#Else
...
#If F22_TYPEA Then
Public Const MAX_CNCPATH = 15
#Else
Public Const MAX_CNCPATH = 10
#End If

#If F22_TYPEA Then
Public Const MAX_IFSB_LINE = 4
#ElseIf F22_TYPEB Then
Public Const MAX_IFSB_LINE = 4
#Else
